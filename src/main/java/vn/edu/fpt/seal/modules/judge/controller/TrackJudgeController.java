...
public class TrackJudgeController {
    ...
    public ResponseEntity<Page<TrackJudgeResponse>> list(@RequestParam(required = false) UUID trackId, @RequestParam(required = false) UUID userId, Pageable pageable) { return ResponseEntity.ok(service.list(trackId, userId, pageable)); }
