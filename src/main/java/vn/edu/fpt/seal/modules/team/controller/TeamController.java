...
public class TeamController {
    ...
    public ResponseEntity<Page<TeamResponse>> listByTrack(@RequestParam(required = false) UUID trackId, Pageable pageable) { return ResponseEntity.ok(teamService.listByTrack(trackId, pageable)); }
    ...
    public ResponseEntity<TeamResponse> reactivate(@PathVariable UUID id) { return ResponseEntity.ok(teamService.reactivate(id)); }
