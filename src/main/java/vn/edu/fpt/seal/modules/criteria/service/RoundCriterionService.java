...
public class RoundCriterionService {
    ...
    @Transactional(readOnly = true) public Page<RoundCriterionResponse> list(UUID roundId, Pageable pageable) { return criterionRepository.findByRoundId(roundId, pageable).map(RoundCriterionMapper::toResponse); }
