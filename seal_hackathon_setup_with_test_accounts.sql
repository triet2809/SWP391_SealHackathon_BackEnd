-- ============================================================================
-- SEAL Hackathon — FULL self-contained setup + demo test accounts
-- ============================================================================
-- Copy-paste this whole file into any PostgreSQL query tool
-- (pgAdmin / DBeaver / psql / DataGrip) connected to an EMPTY database.
-- It creates the schema + reference data, then adds demo accounts.
--
-- Requirements: PostgreSQL 13+ (uses gen_random_uuid via pgcrypto, created below).
-- No psql-only meta-commands, no COPY. Pure SQL.
--
-- DEMO TEST ACCOUNTS (password for ALL = 11111111):
...
--   demo.leader@seal.local  team_leader (in DEMO Team)
--   demo.member@seal.local  team_member (in DEMO Team)
-- Supporting demo data: DEMO Event -> DEMO Track -> DEMO Round 1 -> DEMO Team.
-- ============================================================================
